...
module.exports = yeoman.Base.extend({
  ...
  prompting: function () {
    ...
    this.log(yosay(
      'frontend-dog ' + chalk.red('default') + ' generator!'
    ));
  ...
  writing: function () {
    ...
    var dotfiles = ['.editorconfig', '.gitignore', '.babelrc', '.eslintrc'];
  ...
  install: function () {
    ...
    this.log('I\'m all done. Please running ' + chalk.red('npm install') + ' by yourself.');
  },
  // Called last, cleanup, say good bye, etc
  end: function () {
    this.log('Enjoying it!');
  }
});
